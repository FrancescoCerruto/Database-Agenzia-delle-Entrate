...
<body>
	<form action="stampa_notifiche_utente.php" method="post" id="form_richiesta">
		<div class="container">
			<div class="row">
				<div class="col-sm-3">
					<h1>Richiesta</h1>
	...
	<script type="text/javascript" language="javascript" src="js/notifiche_utente.js"></script>
